<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForgotPassword.aspx.cs" Inherits="RealEstate.ForgotPassword" %>
			...
			<div class="main">
				<section id="content">
					<div class="wrapper">
						<article class="col1">
							<div id="slider">
								<img src="images/homehunt7.jpg" alt="" title="<strong>New Delhi, 2007</strong>" />
								<img src="images/homehunt6.jpg" alt="" title="<strong>Mumbai, 2007</strong>" />
								<img src="images/homehunt8.jpg" alt="" title="<strong>Kolkata, 2007</strong>" />
								<img src="images/homehunt9.jpg" alt="" title="<strong>Chennai, 2010</strong>" />
								<img src="images/slider11.jpg" alt="" title="<strong>Coimbatore, 2003</strong>" />
							</div>
						</article>
						<article class="col2">
							<form id="form_1" method="post" runat="server">
								<div class="pad1">
                                    ...
                                    <asp:Label ID="lblStatus" runat="server" />
                                     ...
                                     <asp:Button runat="server" ID="MailSubmit" class="button" Text="Submit" 
                                        onclick="MailSubmit_Click" />
                                &nbsp;&nbsp;&nbsp;&nbsp;
